...
| `railway-deployment.txt` | Railway deployment SUCCESS, public health/dashboard smoke test, Jaeger cloud smoke trace (4 spans), và controlled `tool_fail` error trace (HTTP 500, trace `2162c3727446f94638dee47762cfe430`, span status ERROR). |
| `langfuse-trace.png` | Screenshot Langfuse UI thật của trace `a5210fa25704aa293b0a3352c48e7015` (Mai Anh). |
| `dashboard-baseline.png` / `dashboard-rag-slow.png` | Screenshot dashboard runtime thật, trạng thái bình thường và khi bật incident `rag_slow` (Mai Anh). |
